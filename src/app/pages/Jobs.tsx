...
export default function PostJob() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <Seo
        title="Post a Job in Russia | Hire International Candidates | AfroPals Jobs"
        description="Post a verified job in Russia and connect with international candidates through AfroPals Jobs. Trusted employer support, recruitment visibility, and transparent hiring."
      />
      ...
      <section className="py-16 bg-white border-t border-gray-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-2xl md:text-3xl mb-6">
            Hire International Candidates in Russia
          </h2>

          <p className="text-gray-700 mb-4 leading-7">
            AfroPals Jobs gives employers a professional way to present genuine
            vacancies to international candidates seeking trusted work
            opportunities in Russia. The platform is designed for serious
            employers, families, and organizations looking for transparent hiring support.
          </p>

          <p className="text-gray-700 mb-4 leading-7">
            By posting through AfroPals Jobs, employers can improve visibility,
            reach motivated foreign candidates, and support a more structured
            recruitment process.
          </p>

          <p className="text-gray-700 leading-7">
            We aim to reduce confusion, improve trust, and help both employers
            and applicants move forward professionally.
          </p>
        </div>
      </section>
