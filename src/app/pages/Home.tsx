          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8">
                Connect with top companies and unlock your career potential. Thousands of opportunities waiting for you.
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button className="text-sm text-blue-600 hover:underline">Developer</button>
                <button className="text-sm text-blue-600 hover:underline">Designer</button>
                <button className="text-sm text-blue-600 hover:underline">Manager</button>
                <button className="text-sm text-blue-600 hover:underline">Marketing</button>
              </div>
            </div>
